...
public class ArrayReplaceSymbolServiceImplTest {
    ArrayReplaceSymbolServiceImpl replaceSymbolService;
    ...
    @BeforeClass
    public void setUp() {
        replaceSymbolService = new ArrayReplaceSymbolServiceImpl();
    }
